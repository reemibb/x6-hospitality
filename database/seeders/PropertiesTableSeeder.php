    ...
    public function run(): void
    {
        DB::table('properties')->insert([
            [
                ...
                'bedrooms' => 4,
                'bathrooms' => 3.0,
                'amenities' => json_encode(['WiFi', 'Swimming Pool', 'Air Conditioning', 'Kitchen', 'Parking', 'Balcony', 'Garden']),
            ...
            [
                ...
                'bedrooms' => 2,
                'bathrooms' => 2.0,
                'amenities' => json_encode(['WiFi', 'Air Conditioning', 'Kitchen', 'TV', 'Elevator', 'Security System']),
            ...
            [
                ...
                'bedrooms' => 0,
                'bathrooms' => 1.0,
                'amenities' => json_encode(['WiFi', 'Air Conditioning', 'Kitchen', 'TV']),
                'photos' => json_encode(['public/images/studio1.jpg']),
            ...
            [
                ...
                'bedrooms' => 3,
                'bathrooms' => 2.5,
                'amenities' => json_encode(['WiFi', 'Air Conditioning', 'Swimming Pool', 'Kitchen', 'Parking', 'Balcony', 'Hot Tub', 'Elevator', 'Security System']),
                'photos' => json_encode(['public/images/penthouse1.jpg', 'public/images/penthouse2.jpg']),
